...
public class Main {
    public static void main(String[] args) {
        ...
        // 1. Métodos Síncronos
        System.out.println("---- MÉTODOS SÍNCRONOS ----");
        ...
        deleteSync
                .peek(aVoid -> System.out.println("Usuario eliminado correctamente"))
                .peekLeft(error -> System.err.println("Error: " + error.getMessage()));
       ...
       /*  No bloquees con el get() en un entorno real, es solo para demo, esto bloquea el hilo y para nada es asíncrono
        ...
        try {
            ...
            System.err.println("Error en alguna de las llamadas: " + e.getMessage());
        }
        ...
        Single.zip(
                        ...
                        (users, userById, createdUser, createdUserWithToken) -> {
                            ...
                            System.out.println("-> getAllWithRxJava():");
                            ...
                            System.out.println(createdUserWithToken);
        ...
        System.out.println("\n-> deleteUserWithRxJava(3)");
        Completable rxDeleteUser = service.deleteUserWithRxJava(2);
