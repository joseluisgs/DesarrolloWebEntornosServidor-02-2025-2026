...
public class UserServiceImpl implements UserService {
    ...
    public Single<List<User>> getAllWithRxJava() {
        return userRepository.getAllWithRxJava().subscribeOn(Schedulers.io()); // Ejecutar en el scheduler de IO;
    }

    public Single<List<User>> getAllWithPageRxJava(int page) {
        return userRepository.getAllWithPageRxJava(page).subscribeOn(Schedulers.io()); // Ejecutar en el scheduler de IO
    }

    public Single<User> getByIdWithRxJava(int id) {
        return userRepository.getByIdWithRxJava(id).subscribeOn(Schedulers.io());
    }

    public Single<User> createUserWithRxJava(User user) {
        return userRepository.createUserWithRxJava(user).subscribeOn(Schedulers.io());
    }

    public Single<User> createUserWithTokenWithRxJava(String token, User user) {
        return userRepository.createUserWithTokenWithRxJava(token, user).subscribeOn(Schedulers.io());
    }
    ...
    public Completable deleteUserWithRxJava(int id) {
        return userRepository.deleteUserWithRxJava(id).subscribeOn(Schedulers.io());
    }
}